...
class CookingParamInfoElement(PataponDynamicDataClass, PataponDataClassElement):
    ...
    damageParam: DamageParam = field(default_factory=DamageParam, metadata={"meta": FieldMetadata("dataclass", 3)})


@dataclass
class CookingParamInfo(PataponDynamicDataClass, PataponDataClassBody):
    param_list: list[CookingParamInfoElement] = field(default_factory=list[CookingParamInfoElement], metadata={"meta": FieldMetadata("dataclass", 0), "tags": [FieldTag("cooking_param_count", "count")]})



@dataclass
class CookingParam(PataponDynamicDataClass):
    header: CookingParamHeader = field(default_factory=CookingParamHeader, metadata={"meta": FieldMetadata("dataclass", 0), "tags": [FieldTag("file", "header")]})
    chara_group_params: CookingParamInfo = field(default_factory=CookingParamInfo, metadata={"meta": FieldMetadata("dataclass", 1), "tags": [FieldTag("file", "body")]})