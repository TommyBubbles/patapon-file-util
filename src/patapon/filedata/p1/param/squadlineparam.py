...
class EachCharaParam(PataponDynamicDataClass):
    ...
    priority: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 1)})
    position: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 2)})
    inst_move: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 3)})
    inst_shortRange: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 4)})
    inst_longRange: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 5)})
    inst_charge: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 6)})
    inst_escape: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 7)})
    inst_rsv5: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 8)})
...
class ActivityTableParam(PataponDynamicDataClass):
    ...
    priority: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 1)})
    position: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 2)})
    instruction: list[TierLevelParam] = field(default_factory=list[TierLevelParam], metadata={"meta": FieldMetadata("dataclass", 3, count=5)})
    inst_rsv5: TierLevelParam = field(default_factory=TierLevelParam, metadata={"meta": FieldMetadata("dataclass", 4)})
...
class SquadLineParamInfoElement(PataponDynamicDataClass, PataponDataClassElement):
    ...
    eachCharaData: list[EachCharaParam] = field(default_factory=list[EachCharaParam], metadata={"meta": FieldMetadata("dataclass", 12, count=8)})
    activityTable: list[ActivityTableParam] = field(default_factory=list[ActivityTableParam], metadata={"meta": FieldMetadata("dataclass", 13, count=32)})


@dataclass
class SquadLineParamInfo(PataponDynamicDataClass, PataponDataClassBody):
    param_list: list[SquadLineParamInfoElement] = field(default_factory=list[SquadLineParamInfoElement], metadata={"meta": FieldMetadata("dataclass", 0), "tags": [FieldTag("squad_line_param_count", "count")]})



@dataclass
class SquadLineParam(PataponDynamicDataClass):
    header: SquadLineParamHeader = field(default_factory=SquadLineParamHeader, metadata={"meta": FieldMetadata("dataclass", 0), "tags": [FieldTag("file", "header")]})
    squad_line_params: SquadLineParamInfo = field(default_factory=SquadLineParamInfo, metadata={"meta": FieldMetadata("dataclass", 1), "tags": [FieldTag("file", "body")]})
