...
class ActorParam(PataponStaticDataClass):
    ...
    str6: str = field(default="", metadata={"meta": FieldMetadata("string", 15, size=0x20, encoding="utf-8")})
    localDataName: str = field(default="", metadata={"meta": FieldMetadata("string", 16, size=0x20, encoding="utf-8")})
    padding_3: list[int] = field(default_factory=list, metadata={"meta": FieldMetadata("unsigned_int", 17, count=24)})
    str8: str = field(default="", metadata={"meta": FieldMetadata("string", 18, size=0x20, encoding="utf-8")})
    str9: str = field(default="", metadata={"meta": FieldMetadata("string", 19, size=0x20, encoding="utf-8")})
    str10: str = field(default="", metadata={"meta": FieldMetadata("string", 20, size=0x20, encoding="utf-8")})
    str11: str = field(default="", metadata={"meta": FieldMetadata("string", 21, size=0x20, encoding="utf-8")})